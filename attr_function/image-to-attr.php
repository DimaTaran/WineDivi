...
if( ! class_exists( 'Showcase_Taxonomy_Images' ) ) {
    class Showcase_Taxonomy_Images {
        ...
        public function init() {
            // Image actions
            add_action( 'pa_grape-varieties_add_form_fields', array( $this, 'add_category_image' ), 10, 2 );
            add_action( 'created_pa_grape-varieties', array( $this, 'save_category_image' ), 10, 2 );
            add_action( 'pa_grape-varieties_edit_form_fields', array( $this, 'update_category_image' ), 10, 2 );
            add_action( 'edited_pa_grape-varieties', array( $this, 'updated_category_image' ), 10, 2 );
        ...
        public function add_category_image( $taxonomy ) { ?>
            <div class="form-field term-group">
                <label for="grape-taxonomy-image-id"><?php _e( 'Image', 'showcase' ); ?></label>
        ...
        public function update_category_image( $term, $taxonomy ) { ?>
            <tr class="form-field term-group-wrap">
                <th scope="row">
                    <label for="showcase-taxonomy-image-id"><?php _e( 'Image', 'Divi' ); ?></label>
                </th>
                <td>
        ...
        public function add_script() {
            if( ! isset( $_GET['taxonomy'] ) || $_GET['taxonomy'] != 'pa_grape-varieties' ) {
                return;
            } ?>
